...
| 类型 | Event | Model | View |
| --- | --- | --- | --- |
| Menu | onControllerReset() | - | controllers: map[string]Controller<br>invokeController(name) |
...
| QRectCreator | onmousedown(event)<br>onmousemove(event)<br>onmouseup(event)<br>onkeydown(event) | new QLine(pt1, pt2, style)<br>new QRect(rect, style)<br>new QEllipse(x, y, radiusX, radiusY, style)<br>doc.addShape(shape) | getMousePos(event)<br>invalidateRect(rect)<br>registerController(name, ctrl)<br>fireControllerReset() |
...
| 类型 | Event | Model | View |
| --- | --- | --- | --- |
| Menu | - | - | controllers: map[string]Controller<br>invokeController(name) |
...
| QRectCreator | onmousedown(event)<br>onmousemove(event)<br>onmouseup(event)<br>onkeydown(event) | new QLine(pt1, pt2, style)<br>new QRect(rect, style)<br>new QEllipse(x, y, radiusX, radiusY, style)<br>doc.addShape(shape) | getMousePos(event)<br>invalidateRect(rect)<br>registerController(name, ctrl) |
